...
our $SCHEMA = [
    ...
    # Gaming entries, kept here so they survive every menu regeneration.
    # (Editing menu.xml directly is pointless now - obmenu-generator overwrites it.)
    {sep => 'Games'},
    {item => ['steam',                                          'Steam',                           'steam']},
    {item => ['steam -bigpicture',                              'Steam (Big Picture)',             'steam']},
    {item => ['gamescope -f -e -- steam -bigpicture -tenfoot',  'Steam (Big Picture in gamescope)', 'steam']},
